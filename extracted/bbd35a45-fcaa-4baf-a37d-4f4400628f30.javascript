/* Sog'liq Industriyasi — Floating widgets: FAB + chat channels + callback modal */
...
function FloatingWidgets({ lang, go }) {
  ...
  const CHANNELS = [
    ...
    { icon:"wa", label:"WhatsApp",    color:"#25D366", bg:"#e8faf0", href:"https://wa.me/998773870001?text=Здравствуйте!%20Пишу%20с%20Sog'liq Industriyasi." },
