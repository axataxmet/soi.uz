/* Sog'liq Industriyasi — cart, wishlist, compare, quote modal, compare bar, info pages */
...
<title>${num} — Sog'liq Industriyasi</title>
<style>
...
<div class="header">
  <div>
    ...
    <div style="font-size:11px;color:#555;margin-top:4px">100069, Ташкент, Узбекистан, ул. МКАД, д. 16<br>
    +998 (77) 225-00-01 · info@sogliqindustriyasi.uz</div>
  </div>
  <div class="meta">
...
<div class="footer-note">
  Цены указаны без НДС и носят справочный характер. Для получения актуального коммерческого предложения менеджер Sog'liq Industriyasi свяжется с вами в течение одного рабочего дня.
</div>
<div class="stamp">Sog'liq Industriyasi · Коммерческое предложение</div>
</body></html>`;
...
<div class="footer-note">
  Настоящий документ является запросом коммерческого предложения. Менеджер Sog'liq Industriyasi свяжется с вами в течение одного рабочего дня для уточнения деталей и предоставления актуального прайса.
</div>
<div class="stamp">Sog'liq Industriyasi · Запрос принят</div>
</body></html>`;
      ...
      <div style={{ maxWidth: 760 }}>
        ...
        <p style={{ color: "var(--slate-600)", fontSize: 16, lineHeight: 1.7, marginTop: 16 }}>
          {lang === "uz"
            ...
            : lang === "en"
            ? "This section is not filled in the demo prototype. Sog'liq Industriyasi is a platform supplying equipment for medical institutions in Uzbekistan."
