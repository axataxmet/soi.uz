/* Sog'liq Industriyasi — Sitemap page (Карта сайта) */
  ...
  return (
    <div className="wrap" style={{ padding: "44px 0 80px" }}>
      ...
      <p style={{ fontSize: 15, color: "var(--slate-600)", marginBottom: 40, maxWidth: 640 }}>
        {lv("Все разделы и страницы платформы Sog'liq Industriyasi в одном месте.",
            "Sog'liq Industriyasi platformasining barcha bo'limlari va sahifalari bir joyda.",
            "All sections and pages of the Sog'liq Industriyasi platform in one place.")}
      </p>
