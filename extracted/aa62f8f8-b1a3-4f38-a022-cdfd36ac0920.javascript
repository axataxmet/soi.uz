/* Sog'liq Industriyasi — Company info pages with real content */
...
const INFO_CONTENT = {
  about: {
    ru: {
      title: "О компании",
      sections: [
        { head: "Кто мы", body: "Sog'liq Industriyasi — специализированная платформа поставки медицинского оборудования и расходных материалов для государственных и частных медицинских учреждений Республики Узбекистан. Работаем с 2014 года. За 12 лет мы стали одним из ведущих B2B-поставщиков медтехники в стране." },
    ...
    en: {
      title: "About Us",
      sections: [
        { head: "Who we are", body: "Sog'liq Industriyasi is a specialized B2B platform for medical equipment supply to public and private healthcare institutions across Uzbekistan. Operating since 2014, we have become one of the country's leading medical technology distributors." },
  ...
  suppliers: {
    ru: { title: "Поставщикам", sections: [
      { head: "Станьте нашим партнёром", body: "Sog'liq Industriyasi — дистрибьюторская платформа с прямым выходом на 500+ медицинских учреждений Узбекистана. Если вы производитель или официальный дистрибьютор медицинской техники, мы готовы рассмотреть партнёрство." },
      ...
      { head: "Как стать партнёром", body: "Заполните заявку или позвоните нам по номеру +998 (77) 225-00-01. Менеджер по развитию партнёрской сети свяжется с вами в течение рабочего дня для первичного обсуждения." },
    ]},
    en: { title: "For Suppliers", sections: [
      { head: "Become our partner", body: "Sog'liq Industriyasi is a distribution platform with direct access to 500+ medical institutions across Uzbekistan. If you are a manufacturer or authorized distributor of medical equipment, we invite you to explore a partnership." },
      ...
      { head: "How to join", body: "Fill out the application form or call us at +998 (77) 225-00-01. Our partner development manager will contact you within one business day." },
    ]}
  },
  contacts: {
    ru: { title: "Контакты" },
  ...
  privacy: {
    ru: { title: "Политика конфиденциальности", sections: [
      { head: "Общие положения", body: "Настоящая Политика обработки персональных данных разработана в соответствии с Законом Республики Узбекистан «О персональных данных» № ЗРУ-547 от 02.07.2019 и определяет порядок обработки и защиты персональных данных пользователей сайта Sog'liq Industriyasi." },
      ...
      { head: "Контакты по вопросам данных", body: "По всем вопросам обработки персональных данных обращайтесь: info@sogliqindustriyasi.uz, +998 (77) 225-00-01, 100069, Ташкент, Узбекистан, ул. МКАД, д. 16." },
    ]},
    uz: { title: "Maxfiylik siyosati", sections: [
      ...
      { head: "Ma'lumotlar bo'yicha aloqa", body: "Shaxsiy ma'lumotlarni qayta ishlash bo'yicha barcha savollar uchun: info@sogliqindustriyasi.uz, +998 (77) 225-00-01, 100069, Toshkent, O'zbekiston, MKAD ko'chasi, 16-uy." },
    ]},
    en: { title: "Privacy Policy", sections: [
      { head: "General provisions", body: "This Personal Data Processing Policy is developed in accordance with the Law of the Republic of Uzbekistan 'On Personal Data' No. ZRU-547 dated 02.07.2019 and defines how Sog'liq Industriyasi processes and protects the personal data of website users." },
      ...
      { head: "Data contacts", body: "For all personal data matters: info@sogliqindustriyasi.uz, +998 (77) 225-00-01, 100069, Tashkent, Uzbekistan, MKAD street, 16." },
    ]},
  },
  offer: {
    ...
    en: { title: "Public Offer", sections: [
      { head: "1. General provisions", body: "This document is a public offer of SOG'LIQ INDUSTRIYASI LLC and contains all the essential terms for the supply of medical equipment. Acceptance of the offer is the placing of an order or signing of a specification/invoice." },
      ...
      { head: "6. Supplier details", body: "SOG'LIQ INDUSTRIYASI LLC, TIN: 300 000 000, 100069, Tashkent, MKAD street, 16." },
    ]},
  },
  returns: {
    ru: { title: "Политика возврата и обмена", sections: [
      ...
      { head: "Порядок возврата", list: ["Направьте заявку на info@sogliqindustriyasi.uz с указанием номера счёта", "Приложите фото/описание дефекта и копии документов", "Менеджер согласует вывоз или передачу товара", "Возврат средств — на расчётный счёт в течение 10 банковских дней"] },
    ]},
    uz: { title: "Qaytarish va almashtirish siyosati", sections: [
      ...
      { head: "Qaytarish tartibi", list: ["info@sogliqindustriyasi.uz ga hisob raqamini ko'rsatib ariza yuboring", "Nuqson foto/tavsifi va hujjat nusxalarini ilova qiling", "Menejer tovarni olib ketishni kelishadi", "Pul qaytarish — 10 bank kuni ichida"] },
    ]},
    en: { title: "Return & Exchange Policy", sections: [
      ...
      { head: "Return procedure", list: ["Send a request to info@sogliqindustriyasi.uz with the invoice number", "Attach photo/description of the defect and document copies", "A manager will arrange pickup or transfer", "Refund to the bank account within 10 banking days"] },
    ]},
  },
  service_reg: {
    ru: { title: "Сервисный регламент", sections: [
      { head: "Авторизованный сервисный центр", body: "Sog'liq Industriyasi располагает собственным авторизованным сервисным центром в Ташкенте со штатом сертифицированных инженеров. Мы обслуживаем всё поставляемое оборудование на гарантийной и постгарантийной основе." },
      ...
      { head: "Как оставить заявку", body: "Сервисная заявка: info@sogliqindustriyasi.uz или +998 (77) 225-00-01. Укажите модель, серийный номер и описание неисправности — это ускорит обработку." },
    ]},
    uz: { title: "Servis reglamenti", sections: [
      ...
      { head: "Ariza qoldirish", body: "Servis arizasi: info@sogliqindustriyasi.uz yoki +998 (77) 225-00-01. Model, seriya raqami va nosozlik tavsifini ko'rsating." },
    ]},
    en: { title: "Service Regulations", sections: [
      { head: "Authorized service centre", body: "Sog'liq Industriyasi operates its own authorized service centre in Tashkent staffed by certified engineers. We service all supplied equipment on a warranty and post-warranty basis." },
      ...
      { head: "How to request service", body: "Service request: info@sogliqindustriyasi.uz or +998 (77) 225-00-01. Provide the model, serial number and fault description." },
    ]},
  },
  licenses: {
    ru: { title: "Лицензии и сертификаты", sections: [
      ...
      { head: "Получить копии документов", body: "Полный пакет документов на конкретную позицию предоставляется по запросу при подготовке коммерческого предложения. Обращайтесь: info@sogliqindustriyasi.uz." },
    ]},
    uz: { title: "Litsenziya va sertifikatlar", sections: [
      ...
      { head: "Hujjat nusxalarini olish", body: "Aniq pozitsiya bo'yicha to'liq hujjatlar to'plami so'rov bo'yicha taqdim etiladi: info@sogliqindustriyasi.uz." },
    ]},
    en: { title: "Licenses & Certificates", sections: [
      ...
      { head: "Company documents", list: ["Certificate of state registration of SOG'LIQ INDUSTRIYASI LLC", "License for wholesale/retail sale of medical devices", "Authorization letters from manufacturers (distribution agreements)", "ISO quality management system certificates"] },
      { head: "Obtain document copies", body: "A full document package for a specific item is provided on request when preparing a quote. Contact: info@sogliqindustriyasi.uz." },
    ]},
  },
  gov: {
    ru: { title: "Для государственных закупок", sections: [
      { head: "Надёжный поставщик для госсектора", body: "Sog'liq Industriyasi — проверенный поставщик медицинского оборудования для государственных и бюджетных учреждений здравоохранения Республики Узбекистан. Мы работаем с государственными закупками в полном соответствии с законодательством." },
      ...
      { head: "Связаться по госзакупкам", body: "Отдел тендеров и госзакупок: info@sogliqindustriyasi.uz, +998 (77) 225-00-01. Направьте техническое задание — подготовим коммерческое предложение в течение 1 рабочего дня." },
    ]},
    uz: { title: "Davlat xaridlari uchun", sections: [
      ...
      { head: "Davlat xaridlari bo'yicha aloqa", body: "Tender va davlat xaridlari bo'limi: info@sogliqindustriyasi.uz, +998 (77) 225-00-01." },
    ]},
    en: { title: "For Government Procurement", sections: [
      { head: "A reliable supplier for the public sector", body: "Sog'liq Industriyasi is a trusted supplier of medical equipment for state and budget healthcare institutions of the Republic of Uzbekistan. We handle government procurement in full compliance with the law." },
      ...
      { head: "Procurement contacts", body: "Tender & government procurement department: info@sogliqindustriyasi.uz, +998 (77) 225-00-01." },
    ]},
  }
};
        ...
        <div style={{ maxWidth: 1040 }}>
          ...
          <div style={{ maxWidth: 600, marginTop: 40 }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 14, color: "var(--slate-600)" }}>+998 (77) 225-00-01</div>
            </div>
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 14, color: "var(--slate-600)" }}>+998 (77) 224-00-01</div>
            </div>
      ...
      <div className="info-layout">
        ...
        <aside className="info-side">
          <div className="info-side-card">
            ...
            <a className="nav-phone" href="tel:+998772250001" style={{ marginTop:12, display:"flex", gap:8, color:"var(--ink)", fontWeight:800, fontSize:17 }}>
