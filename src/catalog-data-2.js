/* Sog'liq Industriyasi — content (RU / UZ / EN) + data */
window.SI = (function () {
  ...
  const T = {
    ru: {
      code: "RU",
      // nav
      brand_name: "Sog'liq Industriyasi",
      ...
      nav_documents: "Документы", nav_news: "Новости",
      ...
      f_rights: "© 2026 Sog'liq Industriyasi. Все права защищены.",
      // contacts
    ...
    uz: {
      code: "UZ",
      brand_name: "Sog'liq Industriyasi", brand_tag: "Salomatlik industriyasi",
      ...
      nav_documents: "Hujjatlar", nav_news: "Yangiliklar",
    ...
    en: {
      code: "EN",
      brand_name: "Sog'liq Industriyasi", brand_tag: "Health Industry",
      ...
      nav_documents: "Documents", nav_news: "News",
      ...
      f_rights: "© 2026 Sog'liq Industriyasi. All rights reserved.",
  ...
  const PROJECTS = [
    { id: "p1", img: "", tag: L("Госучреждение","Davlat muassasasi","Public institution"),
      t: L("Оснащение областной многопрофильной больницы","Viloyat ko'p tarmoqli kasalxonasini jihozlash","Equipping a regional multidisciplinary hospital"),
      d: L("Полный комплекс диагностического и реанимационного оборудования для нового корпуса.","Yangi korpus uchun diagnostika va reanimatsiya uskunalari majmuasi.","A full set of diagnostic and ICU equipment for a new wing."),
      year: "2024", scope: L("180+ единиц","180+ birlik","180+ units"), loc: L("Самарканд","Samarqand","Samarkand"), type:"gov" },
    { id: "p2", img: "", tag: L("Частная клиника","Xususiy klinika","Private clinic"),
      t: L("Диагностический центр «под ключ»","«Kalit ostida» diagnostika markazi","Turnkey diagnostic center"),
      d: L("УЗИ, рентген, лаборатория и мебель с монтажом и обучением персонала.","UZI, rentgen, laboratoriya va mebel montaj va o'qitish bilan.","Ultrasound, X-ray, lab and furniture with installation and training."),
      year: "2023", scope: L("«Под ключ»","«Kalit ostida»","Turnkey"), loc: L("Ташкент","Toshkent","Tashkent"), type:"private" },
    { id: "p3", img: "", tag: L("Госучреждение","Davlat muassasasi","Public institution"),
      t: L("Поставка реанимационного оборудования","Reanimatsiya uskunalarini yetkazish","ICU equipment supply"),
      d: L("Аппараты ИВЛ, мониторы пациента и дефибрилляторы для районных больниц.","IVL apparatlari, bemor monitorlari va defibrillyatorlar.","Ventilators, patient monitors and defibrillators for district hospitals."),
      year: "2023", scope: L("90+ единиц","90+ birlik","90+ units"), loc: L("Фергана","Farg'ona","Fergana"), type:"gov" },
    { id: "p4", img: "", tag: L("Лаборатория","Laboratoriya","Laboratory"),
      t: L("Оснащение клинико-диагностической лаборатории","Klinik-diagnostika laboratoriyasini jihozlash","Equipping a clinical diagnostic laboratory"),
      d: L("Анализаторы, центрифуги и расходные материалы с сервисным договором.","Analizatorlar, sentrifugalar va sarf materiallari servis shartnomasi bilan.","Analyzers, centrifuges and consumables with a service contract."),
      year: "2022", scope: L("Комплекс","Majmua","Complex"), loc: L("Бухара","Buxoro","Bukhara"), type:"private" },
    { id: "p5", img: "", tag: L("Госучреждение","Davlat muassasasi","Public institution"),
      t: L("Перинатальный центр: неонатология","Perinatal markaz: neonatologiya","Perinatal center: neonatology"),
      d: L("Инкубаторы, открытые реанимационные системы и фототерапия для новорождённых.","Inkubatorlar, ochiq reanimatsiya tizimlari va fototerapiya.","Incubators, open care systems and phototherapy for newborns."),
      year: "2024", scope: L("70+ единиц","70+ birlik","70+ units"), loc: L("Андижан","Andijon","Andijan"), type:"gov" },
    { id: "p6", img: "", tag: L("Частная клиника","Xususiy klinika","Private clinic"),
      t: L("Хирургическое отделение и стерилизация","Jarrohlik bo'limi va sterilizatsiya","Surgical department and sterilization"),
      d: L("Операционные столы, светильники, электрохирургия и ЦСО.","Operatsiya stollari, chiroqlar, elektroxirurgiya va MSB.","Operating tables, lights, electrosurgery and CSSD."),
      year: "2022", scope: L("«Под ключ»","«Kalit ostida»","Turnkey"), loc: L("Ташкент","Toshkent","Tashkent"), type:"private" },
  ];

  const LEADERS = [
    { id: "l1", img: "", name: L("Имя Фамилия","Ism Familiya","Name Surname"), role: L("Генеральный директор","Bosh direktor","CEO") },
    { id: "l2", img: "", name: L("Имя Фамилия","Ism Familiya","Name Surname"), role: L("Коммерческий директор","Tijorat direktori","Commercial Director") },
    { id: "l3", img: "", name: L("Имя Фамилия","Ism Familiya","Name Surname"), role: L("Технический директор","Texnik direktor","Technical Director") },
    { id: "l4", img: "", name: L("Имя Фамилия","Ism Familiya","Name Surname"), role: L("Руководитель сервиса","Servis rahbari","Head of Service") },
  ];
  ...
  const LICENSES = [
    { cat:"license", t: L("Лицензия на мед. деятельность","Tibbiy faoliyat litsenziyasi","Medical activity license"), d: L("Министерство здравоохранения РУз","O'zR Sog'liqni saqlash vazirligi","Ministry of Health of Uzbekistan"), type: L("Лицензия","Litsenziya","License"), date: "2025", langs: "RU/UZ", href: "" },
    { cat:"company", t: L("Карточка компании","Kompaniya kartasi","Company card"), d: L("Реквизиты ООО","MChJ rekvizitlari","LLC details"), type: "PDF", date: "2026", langs: "RU", href: "assets/company-card.pdf" },
    { cat:"company", t: L("Свидетельство о регистрации","Ro'yxatga olish guvohnomasi","Registration certificate"), d: L("Регистрационный документ","Ro'yxatga olish hujjati","Registration document"), type: "PDF", date: "2026", langs: "RU", href: "assets/registration.pdf" },
    { cat:"company", t: L("Сведения о юридическом лице","Yuridik shaxs to'g'risidagi ma'lumotlar","Legal entity information"), d: L("Актуальная выписка из госреестра","Davlat reestridan dolzarb ko'chirma","Current state register extract"), type: "PDF", date: "2026", langs: "RU", href: "assets/egrul.pdf" },
    { cat:"legal", t: L("Договор-оферта поставки","Yetkazib berish oferta-shartnomasi","Supply offer agreement"), d: L("Публичный договор поставки","Ommaviy yetkazib berish shartnomasi","Public supply contract"), type: "PDF", date: "2026", langs: "RU", href: "assets/supply-contract.pdf" },
    { cat:"service", t: L("Гарантийные условия","Kafolat shartlari","Warranty terms"), d: L("Сроки и условия гарантии на оборудование","Uskunalar kafolati shartlari","Equipment warranty terms"), type: "PDF", date: "2025", langs: "RU", href: "" },
    { cat:"service", t: L("Сервисный регламент","Servis reglamenti","Service regulations"), d: L("Порядок технического обслуживания","Texnik xizmat ko'rsatish tartibi","Maintenance procedure"), type: "PDF", date: "2025", langs: "RU", href: "" },
    { cat:"license", t: L("Сертификаты соответствия","Muvofiqlik sertifikatlari","Certificates of conformity"), d: L("На поставляемое оборудование","Yetkazilayotgan uskunalar uchun","For supplied equipment"), type: L("Сертификат","Sertifikat","Certificate"), date: "2025", langs: "RU/UZ", href: "" },
    { cat:"license", t: L("Дилерские сертификаты","Diler sertifikatlari","Dealer certificates"), d: L("Официальное представительство","Rasmiy vakillik","Official representation"), type: L("Сертификат","Sertifikat","Certificate"), date: "2025", langs: "EN", href: "" },
  ];

  return { T, STATS, SERVICES, BRANDS, PROJECTS, LEADERS, VALUES, LICENSES };
})();
