/* Sog'liq Industriyasi — Personal account page */
...
function AccKP({ lv, t, go }) {
  ...
  function exportKP(){
    ...
    const html = `<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"/><title>${num} — Sog'liq Industriyasi</title>
<style>*{margin:0;padding:0;box-sizing:border-box}body{font-family:Arial,sans-serif;font-size:13px;color:#111;padding:40px}.logo{font-size:22px;font-weight:900;color:#1757c8;letter-spacing:-1px}.logo span{color:#0d96be}.header{display:flex;justify-content:space-between;align-items:flex-start;border-bottom:2px solid #1757c8;padding-bottom:16px;margin-bottom:24px}.meta{text-align:right;font-size:12px;color:#555;line-height:1.6}h2{font-size:17px;font-weight:700;margin-bottom:16px;color:#1757c8}table{width:100%;border-collapse:collapse;margin-bottom:18px}th{background:#f0f4ff;padding:8px 10px;text-align:left;font-size:12px;color:#1757c8;border:1px solid #dde3f5}td{padding:8px 10px;border:1px solid #e5e8ef}.total-row td{font-size:15px;font-weight:800;color:#1757c8;background:#f8faff}.footer-note{font-size:11px;color:#777;border-top:1px solid #e5e8ef;padding-top:12px;margin-top:12px}@media print{body{padding:20px}}</style></head><body>
<div class="header"><div><div class="logo">Sog'liq Industriyasi</div><div style="font-size:11px;color:#555;margin-top:4px">100069, Ташкент, ул. МКАД, д.16<br>+998 (77) 225-00-01 · info@sogliqindustriyasi.uz</div></div><div class="meta"><strong style="font-size:15px">${num}</strong><br>Дата: ${date}<br>Действителен: 14 дней</div></div>
...
<div class="footer-note">Цены без НДС, справочные. Менеджер Sog'liq Industriyasi свяжется в течение одного рабочего дня.</div></body></html>`;
