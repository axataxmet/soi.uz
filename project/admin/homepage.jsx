    ...
    <div>
      ...
      {tab === "eco" && (
        <div className="adm-card">
          ...
          <div className="adm-card-body">
            <div className="adm-form">
              {/* No language tabs here: the tile texts live in code and the only
                  editable values left are numbers, which are the same in RU/UZ/EN. */}
              <div className="adm-page-sub" style={{ marginBottom: 12 }}>
                Крупные числа плиток — одинаковые для всех языков.
                Счётчики тендеров берутся из системы автоматически и здесь не редактируются.
              </div>
              <div className="adm-form-row cols3">
