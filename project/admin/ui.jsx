...
(function () {
  ...
  const DIRECTION_GROUPS = [
    { id:"diag_group",    icon:"stethoscope",       color:"#1a5fd0",
    ...
    { id:"clinical_group",icon:"face",       color:"#15a06a",
    ...
    { id:"surgery_group", icon:"ambulance",     color:"#e0492f",
    ...
    { id:"rehab_group",   icon:"spine",        color:"#7c5cbf",
