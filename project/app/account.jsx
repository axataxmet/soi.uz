...
<div class="header"><div><div class="logo">ИНДУСТРИЯ ЗДОРОВЬЯ</div><div style="font-size:11px;color:#555;margin-top:4px">${contacts.address}<br>${contacts.phone} · ${contacts.email}</div></div><div class="meta"><strong style="font-size:15px">${num}</strong><br>Дата: ${date}<br>Действителен: 14 дней</div></div>
