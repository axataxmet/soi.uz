    ...
    <div
      ...
      ready ?<div className="hvs-fallback">
          ...
          <div className="hvs-stats">
            {[
              {n:"30+", l:"наименований", ic:"grid", c:"var(--blue-600)"},
...
function HeroSignals({ lang, go }) {
  ...
  const sigs = [
    { ic: "grid",  cls: "s1", bg: "var(--blue-50)", c: "var(--blue-600)",
      t: lv("30+ позиций", "30+ pozitsiya", "30+ items"),
        ...
        <div className="sx-cp sx-rv">
          ...
          <div className="sx-cp-inner">
            ...
            <div>
              ...
              <h2 className="sx-cp-h2">{lv("30+ единиц оборудования для медицины", "Tibbiyot uchun 30+ birlik uskunalar", "30+ units of medical equipment")}</h2>
