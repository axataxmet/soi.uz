    ...
    <div
      ...
      ready ?<div className="hvs-fallback">
          ...
          <div className="hvs-stats">
            {[
              {n:"43+", l:"наименований", ic:"grid", c:"var(--blue-600)"},
...
function HeroSignals({ lang, go }) {
  ...
  const sigs = [
    { ic: "grid",  cls: "s1", bg: "var(--blue-50)", c: "var(--blue-600)",
      t: lv("43+ позиций", "43+ pozitsiya", "43+ items"),
        ...
        <div className="sx-cp sx-rv">
          ...
          <div className="sx-cp-inner">
            ...
            <div>
              ...
              <h2 className="sx-cp-h2">{lv("43+ единиц оборудования для медицины", "Tibbiyot uchun 43+ birlik uskunalar", "43+ units of medical equipment")}</h2>
