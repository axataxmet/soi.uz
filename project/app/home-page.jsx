    ...
    <div
      ...
      ready ?<div className="hvs-fallback">
          ...
          <div className="hvs-stats">
            {[
              {n:"62+", l:"наименований", ic:"grid", c:"var(--blue-600)"},
...
function HeroSignals({ lang, go }) {
  ...
  const sigs = [
    { ic: "grid",  cls: "s1", bg: "var(--blue-50)", c: "var(--blue-600)",
      t: lv("62+ позиций", "62+ pozitsiya", "62+ items"),
        ...
        <div className="sx-cp sx-rv">
          ...
          <div className="sx-cp-inner">
            ...
            <div>
              ...
              <h2 className="sx-cp-h2">{lv("62+ единиц оборудования для медицины", "Tibbiyot uchun 62+ birlik uskunalar", "62+ units of medical equipment")}</h2>
