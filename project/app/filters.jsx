/* ИНДУСТРИЯ ЗДОРОВЬЯ — Прайс-лист (упрощённый) */
...
function PricePage({ t, lang, go }) {
  ...
  const downloadCSV = () => {
    ...
    a.download = "ИНДУСТРИЯ ЗДОРОВЬЯ_Прайс-лист_" + new Date().toISOString().slice(0,10) + ".csv";
    a.click();
  ...
  return (
    <div className="wrap" style={{padding:"40px 0 80px",maxWidth:600,margin:"0 auto",textAlign:"center"}}>
      ...
      <h1 style={{fontSize:32,fontWeight:800,letterSpacing:"-.02em",marginBottom:8}}>
        {lv("Прайс-лист ИНДУСТРИЯ ЗДОРОВЬЯ","SOG’LIQ INDUSTRIYASI narxlar ro'yxati","HEALTH INDUSTRY Price List")}
      </h1>
