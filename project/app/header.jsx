/* ИНДУСТРИЯ ЗДОРОВЬЯ — header, search, mega-menu, nav */
    ...
    <header className={"head" + (scrolled ? " scrolled" : "")}>
      <div className="wrap">
        ...
        <div className="brand" onClick={() => go("home")} style={{ cursor: "pointer" }}>
          <img className="brand-mark" src={window.__asset("assets/soi-mark-white.svg")} alt="ИНДУСТРИЯ ЗДОРОВЬЯ" />
        </div>
    ...
    <div className={"sticky-bar" + (shown ? " on" : "")} style={{ transform: shown ? "translateY(0)" : "translateY(-100%)", opacity: shown ? 1 : 0, pointerEvents: shown ? "auto" : "none" }}>
      <div className="wrap">
        <div className="sb-brand" onClick={() => go("home")}>
          <img className="brand-mark sb-mark" src={window.__asset("assets/soi-mark-white.svg")} alt="ИНДУСТРИЯ ЗДОРОВЬЯ" />
        </div>
