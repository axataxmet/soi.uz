...
function PartnersPage({ t, lang, go, goCat }) {
  ...
  return (
    <div>
      ...
      /* Бейдж с числом производителей и кнопка «Стать партнёром» сняты по
         запросу заказчика (15.09.2026). Число осталось динамическим в
         siteFigures() — оно ещё выводится на других страницах. */ />
