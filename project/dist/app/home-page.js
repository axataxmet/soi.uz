...
.sx-dir { position:relative; border:1px solid var(--sx-line); border-radius:var(--sx-r); background:var(--sx-card); padding:34px 30px; transition:transform .3s cubic-bezier(.16,1,.3,1), box-shadow .3s, border-color .3s; }
...
/* min-height вместо расширения псевдоэлементом: вкладка — прямоугольник, и
   поднять её до 44px можно прямо, не сдвинув соседей. */
.sx-rev-tab { min-height:44px; padding:10px 20px; font-size:var(--fs-4); font-weight:600; color:var(--sx-mute); background:transparent; border:none; cursor:pointer; font-family:inherit; position:relative; transition:color .18s; white-space:nowrap; }
